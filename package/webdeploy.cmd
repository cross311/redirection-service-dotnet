@rem ---------------------------------------------------------------------------------
@rem 
@rem This file is a modified version of the redirectionservice.deploy.cmd.
@rem The auto-generated version does not handle paths with spaces.
@rem 
@rem ---------------------------------------------------------------------------------
...
set _DeploySetParametersFile="%RootPath%redirectionservice.SetParameters.xml"
)
...
if not %_ArgComputerNameWithQuote% == "" set _Destination=%_Destination%,wmsvc=%_ArgComputerNameWithQuote%
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%redirectionservice.zip" (
echo "%RootPath%redirectionservice.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package="%RootPath%redirectionservice.zip" -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -allowUntrusted
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package="%RootPath%redirectionservice.zip" -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"  -allowUntrusted
)
...
:usage
echo =========================================================
if not exist "%RootPath%redirectionservice.deploy-readme.txt" (
...
start notepad "%RootPath%redirectionservice.deploy-readme.txt"
)
echo =========================================================
goto :eof
